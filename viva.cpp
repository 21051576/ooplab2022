/*WAP to class template to have a matrix of either int or float. Overload the Binary + operator to add two matrix
M3 = M1 + M2'(transpose of M2) Where M1, M2 and M3 are objects of Matrix Class. Write the input and output to file.
Initialize using dynamic constructor.*/
#include<iostream>
using namespace std;
template<class T>
class Matrix{
